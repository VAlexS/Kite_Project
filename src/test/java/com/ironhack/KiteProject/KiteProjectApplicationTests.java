...
import com.ironhack.KiteProject.models.person.Rol;
...
class KiteProjectApplicationTests {
	...
	void savePerson(){
		Person person = new Person("06593826W", "Victor", Rol.USER, "admin");
	...
	void saveOtherPerson(){
		Person person = new Person("65291847F", "Antonio", Rol.USER, "root");
		personService.createPerson(person);
	}
